...
import MyAccountOverview from "./AccountOverview";
                    ...
                    <div className="card mb-3" style={{ width: "20rem" }}>
                      <ul className="list-group list-group-flush">
                        ...
                        <li className="list-group-item">
                          ...
                          <a
                            href="mailto:ialaneme@yahoo.com"
                            className="nav-link text-left text-dark"
                          >
                            ialaneme@yahoo.com
                          </a>
                          <a
                            href=""
                            className="nav-link text-dark pt-5 font-weight-bold"
                          >
                            CHANGE PASSWORD
                          </a>
                        </li>
                      ...
                      <ul className="list-group list-group-flush">
                        ...
                        <li className="list-group-item">
                          ...
                          <p style={{ fontSize: "14px" }}>
                            Ikenna Alaneme <br /> 9, Alaneme street, Off Comfort
                            oboh Street, Kirikiri Town, Lagos <br /> Kirikiri
                            Prisons <br /> Apapa (Kiri kiri), Lagos
                          </p>
                        </li>
                      </ul>
                    </div>
